...
const VideoCarousel = () => {
    ...
    const handleLoadedMetaData = (i, event) => setLoadedData((prev) => [...prev, event])
    ...
    return (
        <>
                ...
                {highlightsSlides.map((list, i) => (
                    <div key={list.id} id='slider' className='sm:pr-20 pr-10' >
                        <div className='video-carousel_container' >
                            <div className='rounded-3xl flex-center overflow-hidden h-full bg-black w-full' >
                                <video
            ...
            <div className='relative flex-center mt-10' >
                <div className='flex-center py-5 px-7 bg-gray-300 backdrop-blue rounded-full ' >
                    {videoRef.current.map((_, i) => (
                        <span key={i}
                            ref={(el) => (videoDivRef.current[i] = el)}
                            className='mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursor-pointer'
                        >
                            <span className='w-full absolute h-full rounded-full'
